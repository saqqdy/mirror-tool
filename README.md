...
[![AppVeyor](https://img.shields.io/appveyor/ci/saqqdy/mirror-tool.svg?&label=Windows)](https://ci.appveyor.com/project/saqqdy/mirror-tool)
[![codecov](https://img.shields.io/codecov/c/github/saqqdy/mirror-tool.svg)](https://codecov.io/gh/saqqdy/mirror-tool)
[![David](https://img.shields.io/david/saqqdy/mirror-tool.svg)](https://david-dm.org/saqqdy/mirror-tool)
...
```bash
npm i -g mirror-tool --registry=https://registry.npm.taobao.org
# 查看npm配置
npm config list
# 查看环境变量
source ~/.bashrc && env
...
```
cd ~/my-project
mirror-tool --registry=https://registry.npm.taobao.org
```
